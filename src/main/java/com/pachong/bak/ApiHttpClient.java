...
//
//
//import cn.rong.models.*;
//import cn.rong.util.HttpUtil;
//
//public class ApiHttpClient implements Runnable{
//
...
//			FormatType format) throws Exception {
//
//		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(appKey,appSecret, RONGCLOUDURI + "/user/refresh." + format.toString());
//
//		StringBuilder sb = new StringBuilder();
//		sb.append("userId=").append(URLEncoder.encode(userId, UTF8));
//		if (userName != null) {
...
//	
//		  
//	public ApiHttpClient(String appKey, String appSecret,
//			String fromUserId, List<String> toUserIds, Message msg,
//			FormatType format) {
//		this.appKey = appKey;
...
//	public void run() {
//		try{
//		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(appKey,	appSecret,	RONGCLOUDURI + "/message/private/publish." + format.toString());
//		StringBuilder sb = new StringBuilder();
//		sb.append("fromUserId=").append(URLEncoder.encode(fromUserId, UTF8));
//		if (toUserIds != null) {
//			for (int i = 0; i < toUserIds.size(); i++) {
